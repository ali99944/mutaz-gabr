      ...
      sections: [
        {
          title: "مقدمة",
          content:
            "نحن في معتز جبر للتصميم الداخلي نلتزم بحماية خصوصيتك وضمان أمان معلوماتك الشخصية. تصف هذه السياسة كيفية جمعنا واستخدامنا وحمايتنا لمعلوماتك عند استخدام موقعنا وخدماتنا.",
        },
        {
          title: "جمع المعلومات",
          content:
