  ...
  return (
    <section ref={ref} className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-[#004851]">آراء عملائنا</h2>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="p-4 relative">
                <FaQuoteRight className="absolute top-4 left-4 text-[#FF0000] opacity-10 text-6xl" />
                <div className="flex items-center mb-6">
                  <div className="w-20 h-20 rounded-full overflow-hidden ml-4 border-4 border-[#004851aa]">
                    <Image
